class Admins::Reports::TransactionSummaryController < ReportController
  ...
  def report
    redirect_to admins_transaction_summary_path, notice: "Invalid parameters" unless params_valid?
    redirect_to admins_transaction_summary_path, notice: "Invalid Dates. Check Date format" unless dates_valid?
