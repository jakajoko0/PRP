class Admins::TransactionCodesController < ApplicationController
	before_action :set_trans_code, only: [:edit, :update]
	...
	def new
		@trans_code = TransactionCode.new(show_in_royalties: false, show_in_invoicing: false)
	...
	def create
		...
		result = CreateTransactionCode.call(params: trans_code_params, user: current_authenticated )
	...
	def update
		...
		result = UpdateTransactionCode.call(trans_code: @trans_code, params: trans_code_params, user: current_authenticated)
...
private
  ...
  def trans_code_params
  	...
  	.permit(:code, :description, :trans_type, :show_in_royalties, :show_in_invoicing)
  end
end