class Admins::FranchisesUsersController < ApplicationController
  ...
  def create
    ...
    if email_valid?(tmp_email)
      ...
      if there.nil?
        ...
        redirect_to edit_admins_franchise_path(id:fran_id)
      else
  ...
  def update
    if @user.update(user_params)
      ...
      redirect_to edit_admins_franchise_path(id:user_params[:franchise_id].to_i)
    else
