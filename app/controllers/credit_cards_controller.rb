...
# For Users to List, Add, Edit, Delete Credit Cards
class CreditCardsController < ApplicationController
  before_action :set_credit_card, only: %i[edit destroy update]
  before_action :set_years, only: %i[edit update new create]
