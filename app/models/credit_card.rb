class CreditCard < ApplicationRecord
  ...
  def card_icon 
  	case card_type
      when 'V' then "fab fa-cc-visa light-grey-icon"
      when 'M' then "fab fa-cc-mastercard light-grey-icon"
      when 'I' then "fab fa-cc-discover light-grey-icon"
      when "A" then "fab fa-cc-amex light-grey-icon"
    end
  end
  ...
  def name_or_number_has_changed? 
  	self.last_four_changed? || self.card_type_changed?
  end
